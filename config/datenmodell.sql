...
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_SAPREPO_VERSION', 'SAP Repo', 'SO', 'output', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.2', 'PF4SH_SAPREPO_VERSION', 'SAP Repo', 'SO', 'output', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_<ARC>_<ID>_UID_SIDADM', 'UID SIDADM', 'SO', 'output', 'string', 'y');
 insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.2', 'PF4SH_<ARC>_<ID>_UID_SIDADM', 'UID SIDADM', 'SO', 'output', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_TO_NET_MACS1', 'MAC Adresse des Toolservers', 'Toolserver', 'output', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_NAS_<DC>', 'NAS Datacenter', 'NetApp', 'output', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_<ARC>_NET_MACS<ID>_<DC>', 'MAC Adresse des Host', 'SO', 'output', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_ISCSI_HOSTNAMES_<ID>', 'Hosts with ISCSI Devices', 'MajorityMaker', 'input', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_ISCSI_HOSTNAMES_<ID>', 'Hosts with ISCSI Devices', 'SO', 'input', 'string', 'y');
insert into xhanaparameter (parameterversion, parameter, info, arc, iotype, valuetype, mandatory) 
 values ('1.0', 'PF4SH_ISCSI_TARGET', 'ISCSI Server', 'ISCSI', 'input', 'string', 'y');
...
insert into xHANAGENERAL (parameterversion, parameter, solutionversion, sid, arc, value)
  values ('1.0', 'PF4SH_SAPREPO_VERSION', 'BWonHANA', 'Y04', 'SO', 'BWoH_Release_1');
insert into xHANAGENERAL (parameterversion, parameter, solutionversion, sid, arc, value)
  values ('1.2', 'PF4SH_SAPREPO_VERSION', 'BWonHANA', 'Y04', 'SO', 'BWoH_Release_3');

insert into xHANA_SID_PARA (sid, parameterversion, parameter, value, arc) 
  values ('Y04', '1.0', 'PF4SH_<ARC>_<ID>_UID_SIDADM', '6500', 'SO');
insert into xHANA_SID_PARA (sid, parameterversion, parameter, value, arc) 
  values ('Y04', '1.2', 'PF4SH_<ARC>_<ID>_UID_SIDADM', '6500', 'SO');
insert into xHANA_SID_PARA (sid, parameterversion, parameter, value, arc) 
  values ('Netapp01', '1.0', 'PF4SH_NAS_<DC>', 'DC1', 'NetApp');
insert into xHANA_SID_PARA (sid, parameterversion, parameter, value, arc) 
  values ('Toolserver', '1.0', 'PF4SH_TO_NET_MACS1', 'A:B:C:D:E:F', 'Toolserver');
...
insert into xHANA_HOST_PARA (hostname, parameterversion, dcid, parameter, arc, value) 
  values ('hdb10y04-0001', '1.0', '1', 'PF4SH_ISCSI_HOSTNAMES_<ID>', 'SO','hdb10y04-0001');
insert into xHANA_HOST_PARA (hostname, parameterversion, dcid, parameter, arc, value) 
  values ('laszis158', '1.0', '3', 'PF4SH_ISCSI_HOSTNAMES_<ID>', 'MajorityMaker', 'laszis158');
insert into xHANA_HOST_PARA (hostname, parameterversion, dcid, parameter, arc, value) 
  values ('laszis159', '1.0', '3', 'PF4SH_ISCSI_TARGET', 'ISCSI', 'laszis159');
